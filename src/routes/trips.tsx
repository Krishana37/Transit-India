  ...
  if (booking.refundStatus === "credited" && booking.refundedAt) {
    ...
    return (
      <div className="rounded-2xl border border-border/60 bg-muted/40 p-4">
        ...
        <p className="mt-3 text-[11px] text-muted-foreground">Refunds always go to your Transit Wallet.</p>
      </div>
    );
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Button
          ...
          onClick={() => {
            ...
            if (res.ok)
              toast.success("Refund Successfully Credited to Your Transit Wallet.", {
